  ...
  <div>
    ...
    <div style="height: 60px; background-color: #3c7fff; display: flex; align-items: center">
      <div style="width: 200px; display: flex; align-items: center; padding-left: 15px">
        ...
        <span style="font-size: 22px; color: white; margin-left: 5px">商品比价平台</span>
      </div>
...
import {Goods, Setting, SwitchButton, Search, ShoppingCart} from "@element-plus/icons-vue";
